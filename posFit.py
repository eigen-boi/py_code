...
outFileName = "zrho_duvbsdvbisiu.pdf"
ECut = 0
...
def PlotDataPosHist(input_files):
    ...
    Parameters: 
    input_files - Path to the RAT DS file(s) to play around with
    Return: nothing
...
if __name__ == '__main__':
    #file_name = "/SNO+/root_files/Fit6180_sim_1MeVbeta_scint_splitZ_747p5_7.root"
    #Valid_Pos_Plots(file_name)
    pass